...
module.exports = {
  ...
  async forgotPassword(ctx) {
    var email = ctx.request.body.identifier;
  ...
  async register(ctx) {
    ...
    if (!params.confirmPassword) {
      return ctx.badRequest(
        null,
        formatError({
          id: 'Auth.form.error.confirmPassword.provide',
    ...
    if (params.confirmPassword !== params.password) {
      return ctx.badRequest(
        null,
        formatError({
          id: 'Auth.form.error.passwordsNotMaching.provide',
          message: 'Passwords do not match.',
        })
      );
    }
    ...
    if (!params.termsAndConds) {
      return ctx.badRequest(
        null,
        formatError({
          id: 'Auth.form.error.termsAndConds.provide',
    ...
    if (!params.dataAgreement) {
      return ctx.badRequest(
        null,
        formatError({
          id: 'Auth.form.error.dataAgreement.provide',
          message: 'Please agree to the data agreement.',
        })
      );
    }
